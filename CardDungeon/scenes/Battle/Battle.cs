...
public partial class Battle : Node2D
{
	...
	public override void _Ready()
	{
        ...
        PackedScene newScene = GD.Load<PackedScene>(MyHero.Sprite);

        Node2D newSceneInstance = (Node2D)newScene.Instantiate();
        
		newSceneInstance.Translate(new Vector2(178, 348));
		newSceneInstance.Scale = new Vector2(4,4);
